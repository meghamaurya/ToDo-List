    ...
    return (
        <div className='container'>
            ...
            <form className="input-group mb-3 ">
                <input type="text" className="form-control text-add" placeholder="What needs to get done?..." aria-label="Recipient's username" aria-describedby="button-addon2" required value={todo} onChange={(e) => setTodo(e.target.value)} onKeyDown={handleKeyPress} />
